...
~/bin/Optimize_MSE_2DTiles -t ${nbthreads} -n $nIterations -i $infname -o $outfname --outputNextStep $outputNextStep --nbPoints $to --integrandType 2 -g $nItegrandsPerIteration --limit $limit > ${TracesDir}/t_${fname}.txt
...
#lst=(3    4    6    9    13    19    27    39    56    81    117    168    243    350    505    729    1051    1516    2187    3154    4549    6561    9463    13647    19683    28388    40942    59049)
lst=(3    4    6    9    13    19    27    39    56    81    117    168    243    350    505    729    1051    1516    2187    3154    4549    6561)
