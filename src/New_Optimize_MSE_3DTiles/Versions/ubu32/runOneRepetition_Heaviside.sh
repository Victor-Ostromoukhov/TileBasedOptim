...
OutputDir="../../Data/Output/Limited/Heaviside/OutputTiles/Repetition_${repetition}/"
TracesDir="../../Data/Output/Limited/Heaviside/Traces/Repetition_${repetition}/"
nIterations=64
